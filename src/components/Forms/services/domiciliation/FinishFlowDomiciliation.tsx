...
import {
  useCreateSubscriptionFormality,
  useSubmitCreateFormality,
...
const FinishFlowDomiciliation = ({ goToNext }: FormProps) => {
  const {
    formState: { errors },
    handleSubmit,
  } = useFormContext();
  ...
  const { FormalityCreationMutation, isLoading } =
    useCreateSubscriptionFormality();
...
export default FinishFlowDomiciliation;
